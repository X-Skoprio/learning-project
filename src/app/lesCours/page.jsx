            ...
            return (
              <Link href={matiere.link} key={matiere.key}>
                <div className="flex flex-col items-center justify-center cursor-pointer hover:scale-105 duration-300 h-full ">
                  <div
                    data-aos="fade-up"
                    className=" bg-slate-200 hover:bg-primary/90 rounded-xl border-1 border-black flex flex-col items-center justify-center space-y-3 w-full h-40 md:h-40"
                  >
                    {matiere.icon}
                    <h3 className=" px-4 pb-2 text-black font-semibold text-sm md:text-xl">
                      {matiere.nom}
                    </h3>
